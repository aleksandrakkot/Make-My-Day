        ...
        <ul>
            <li>
                ...
                <a class="nonactive" href="/rankings">
                    <svg width="31" height="31" viewBox="0 0 31 31" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M11.0662 26.9231L2 29V4.07692L11.0662 2V26.9231Z" stroke="#000001" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"/>
                        <path d="M11.0662 26.9231L20.1534 29V4.07692L11.0662 2V26.9231Z" stroke="#000001" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"/>
                        <path d="M29.2194 26.9231L20.1533 29V4.07692L29.2194 2V26.9231Z" stroke="#000001" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"/>
                    </svg>
            ...
            <li>
                ...
                <a class="active" href="/search">
                    <svg width="29" height="29" viewBox="0 0 29 29" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M12.3484 23.5139C18.616 23.5139 23.6969 18.474 23.6969 12.2569C23.6969 6.0399 18.616 1 12.3484 1C6.08087 1 1 6.0399 1 12.2569C1 18.474 6.08087 23.5139 12.3484 23.5139Z" stroke="#F68802" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/>
                        <path d="M28.2195 28L20.3677 20.2115" stroke="#F68802" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/>
                    </svg>
