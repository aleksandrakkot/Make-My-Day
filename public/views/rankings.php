...
<div class="base-container" id="<?=json_decode($_COOKIE['logUser'], true)['is_admin']?>">
    <nav class="menu">
        <ul>
            <li>
                ...
                <a class="active" href="/rankings">
                    <svg width="31" height="31" viewBox="0 0 31 31" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M11.0662 26.9231L2 29V4.07692L11.0662 2V26.9231Z" stroke="#F68802" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/>
                        <path d="M11.0662 26.9231L20.1534 29V4.07692L11.0662 2V26.9231Z" stroke="#F68802" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/>
                        <path d="M29.2194 26.9231L20.1533 29V4.07692L29.2194 2V26.9231Z" stroke="#F68802" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/>
                    </svg>
    ...
    <div class="content">
        ...
        <div class="top10">
            <div id="choose-top10">
                <a id="top10-in-country" class="active">TOP 10 IN THE COUNTRY</a>
                <a id="top10-in-world" >TOP 10 IN THE WORLD</a>
            </div>
            <div class="top10-country-results active">
